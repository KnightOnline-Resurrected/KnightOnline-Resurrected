...
void CNpcTableSet::DoFieldExchange(CFieldExchange* pFX)
{
	...
	RFX_Int(pFX, _T("[sFireR]"), m_iFireR);
	RFX_Int(pFX, _T("[sColdR]"), m_iColdR);
	RFX_Int(pFX, _T("[sLightningR]"), m_iLightningR);
	RFX_Int(pFX, _T("[sMagicR]"), m_iMagicR);
	RFX_Int(pFX, _T("[sDiseaseR]"), m_iDiseaseR);
	RFX_Int(pFX, _T("[sPoisonR]"), m_iPoisonR);
	RFX_Int(pFX, _T("[sLightR]"), m_iLightR);
